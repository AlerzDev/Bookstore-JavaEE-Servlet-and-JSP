    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary save-modal" form="<jsp:invoke fragment="formid"/>" value="<jsp:invoke fragment="servlet"/>" name="<jsp:invoke fragment="action"/>">Save</button>
            </div>
        </div>
    </div>
</div>