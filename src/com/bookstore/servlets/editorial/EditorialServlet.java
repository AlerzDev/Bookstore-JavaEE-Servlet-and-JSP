package com.bookstore.servlets.editorial;

import com.bookstore.daos.Editorial;
import com.bookstore.models.Response;
import com.bookstore.repositories.EditorialRepository;
...
public class EditorialServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            Editorial data = gson.fromJson(request.getReader(), Editorial.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Editorial item = services.getById((id));
            if( item != null) {
