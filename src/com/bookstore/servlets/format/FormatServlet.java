package com.bookstore.servlets.format;

import com.bookstore.daos.Format;
import com.bookstore.models.Response;
import com.bookstore.repositories.FormatRepository;
...
@WebServlet(name = "FormatServlet",urlPatterns = "/Format")
public class FormatServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            Format data = gson.fromJson(request.getReader(), Format.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Format item = services.getById((id));
            if( item != null) {
