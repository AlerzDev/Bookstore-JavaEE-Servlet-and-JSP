...
@WebServlet(name = "CompanyCardServlet",urlPatterns = "/CompanyCard")
public class CompanyCardServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            CompanyCard data = gson.fromJson(request.getReader(), CompanyCard.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            CompanyCard item = services.getById((id));
            if( item != null) {
